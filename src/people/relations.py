def describe_relative(person, relative, person_ancestor_distances={}, relative_ancestor_distances={}):
    if person.id != relative.id:
        ...
        if relative in person_ancestor_distances:
            ...
            if distance == 1:
                return 'Madre' if relative.gender == 'F' else 'Padre'
            else:
                base = 'Abuela' if relative.gender == 'F' else 'Abuelo'
            ...
            if distance == 1:
                return 'Hija' if relative.gender == 'F' else 'Hijo'
            else:
                base = 'Nieta' if relative.gender == 'F' else 'Nieto'
                return _describe_offset(base, distance)
        ...
        if ancestors:
            if distance1 == 1 and distance2 == 1:
                return 'Hermana' if relative.gender == 'F' else 'Hermano'
            elif distance1 == 1:
                base = 'Sobrina' if relative.gender == 'F' else 'Sobrino'
                return _describe_offset(base, distance2)
            elif distance2 == 1:
                base = 'Tia' if relative.gender == 'F' else 'Tio'
