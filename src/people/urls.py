...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>\d+)/ancestors/report/undead/$'      , views.ancestors_report_undead, name='report_undead'),
    url(r'^person/(?P<person_id>\d+)/ancestors/report/unburied/$'    , views.ancestors_report_unburied, name='report_unburied'),
    ...
    url(r'^person/(?P<person_id>\d+)/ancestors/report/maiden-names/$', views.ancestors_report_maiden_names, name='report_maiden_names'),
    ...
    url(r'^public/$'                                                 , views.start, name='start'),
    
    url(r'^public/apellidos/$'                                       , views.apellidos, name='apellidos'),
    url(r'^public/nombres/$'                                         , views.nombres, name='nombres'),
]